...
-(void)baseInit
{
    ...
    [self addObserver:self forKeyPath:@"borderWidth"            options:NSKeyValueObservingOptionNew context:nil];
    ...
    [self addObserver:self forKeyPath:@"borderColor"            options:NSKeyValueObservingOptionNew context:nil];
    ...
    [self addObserver:self forKeyPath:@"endRoundedCornersWidth"         options:NSKeyValueObservingOptionNew context:nil];
    [self addObserver:self forKeyPath:@"startRoundedCornersWidth"       options:NSKeyValueObservingOptionNew context:nil];
...
-(void)drawProgressLabelCircleInRect:(CGRect)rect
{
    ...
    self.startLabel.frame =  [self rectForDegree:_startDegree andRect:rect andCornerWitdh:_startRoundedCornersWidth];
    self.endLabel.frame =  [self rectForDegree:_endDegree andRect:rect andCornerWitdh:_endRoundedCornersWidth];
    self.startLabel.layer.cornerRadius = [self borderDeltaWithCornerWitdth:_startRoundedCornersWidth];
    self.endLabel.layer.cornerRadius = [self borderDeltaWithCornerWitdth:_endRoundedCornersWidth];
}
