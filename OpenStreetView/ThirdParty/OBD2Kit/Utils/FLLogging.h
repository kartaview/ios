...
/*
 Trace Macro
 */
#define FLTRACE(...) [OSVUserDefaults sharedInstance].debugLogOBD?[[OSVLogger sharedInstance] logMessage:[NSString stringWithFormat:__VA_ARGS__] withLevel:LogLevelDEBUG]:[NSNull new];
