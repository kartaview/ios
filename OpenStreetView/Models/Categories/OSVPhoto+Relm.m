...
+ (OSVPhoto *)fromRealmObject:(RLMPhoto *)rlmObj {
    ...
    photo.photoData.location        = [[CLLocation alloc] initWithCoordinate:CLLocationCoordinate2DMake(rlmObj.latitude, rlmObj.longitude)
                                                                    altitude:rlmObj.altitude
                                                          horizontalAccuracy:rlmObj.horizontalAccuracy
                                                            verticalAccuracy:rlmObj.verticalAccuracy
                                                                      course:rlmObj.course
                                                                       speed:rlmObj.speed
                                                                   timestamp:rlmObj.timestamp];
